...
import (
	...
	wasmtesting "github.com/PikeEcosystem/wasmd/x/wasm/keeper/wasmtesting"
	"github.com/PikeEcosystem/wasmd/x/wasm/types"
)

// todo check it later after removing voter sampling of tendermint
func TestFromIBCTransferToContract(t *testing.T) {
	t.Skip("check it later after removing voter sampling of tendermint")
