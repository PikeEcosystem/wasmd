...
type Model struct {
	...
	Key github_com_PikeEcosystem_tendermint_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=key,proto3,casttype=github.com/PikeEcosystem/tendermint/libs/bytes.HexBytes" json:"key,omitempty"`
