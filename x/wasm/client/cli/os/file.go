...
// This is same file with https://github.com/PikeEcosystem/cosmos-sdk/blob/main/internal/os/file.go
// If the file.go of PikeEcosystem/cosmos-sdk move to other directory not internal, please use cosmos-sdk's file.go
