...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_55381a259c753e1a, []int{0}
}
...
func (m *GenesisState) GetRandomvalList() []Randomval {
	if m != nil {
		return m.RandomvalList
	}
	return nil
}

func (m *GenesisState) GetUservalList() []Userval {
	if m != nil {
		return m.UservalList
	}
	return nil
}
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "PikeEcosystem.pikechain.random.GenesisState")
}
...
var fileDescriptor_55381a259c753e1a = []byte{
	...
	,
	...
	0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x14, 0xb7, 0xea, 0xc3, 0xdd, 0xaa, 0x5f, 0xa1,
	0x0f, 0x4b, 0x81, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xf4, 0x65, 0x0c, 0x08, 0x00, 0x00,
	0xff, 0xff, 0xf8, 0x1d, 0x50, 0xcb, 0x19, 0x03, 0x00, 0x00,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UservalList) > 0 {
		for iNdEx := len(m.UservalList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UservalList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.RandomvalList) > 0 {
		for iNdEx := len(m.RandomvalList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RandomvalList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	_ = l
	if len(m.RandomvalList) > 0 {
		for _, e := range m.RandomvalList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.UservalList) > 0 {
		for _, e := range m.UservalList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RandomvalList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RandomvalList = append(m.RandomvalList, Randomval{})
			if err := m.RandomvalList[len(m.RandomvalList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UservalList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UservalList = append(m.UservalList, Userval{})
			if err := m.UservalList[len(m.UservalList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
