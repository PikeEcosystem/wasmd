...
HTTPS_GIT := https://github.com/PikeEcosystem/wasmd.git
...
ldflags = -X github.com/PikeEcosystem/wasmd/version.Name=wasm \
		  -X github.com/PikeEcosystem/wasmd/version.AppName=wasmd \
		  -X github.com/PikeEcosystem/wasmd/version.Version=$(VERSION) \
		  -X github.com/PikeEcosystem/wasmd/version.Commit=$(COMMIT) \
		  -X github.com/PikeEcosystem/wasmd/app.Bech32Prefix=wasm \
		  -X "github.com/PikeEcosystem/wasmd/version.BuildTags=$(build_tags_comma_sep)"

ifeq ($(WITH_CLEVELDB),yes)
  ldflags += -X github.com/PikeEcosystem/wasmd/types.DBBackend=cleveldb
endif
...
format: format-tools
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -path "./client/lcd/statik/statik.go" | xargs goimports -w -local github.com/PikeEcosystem/wasmd
