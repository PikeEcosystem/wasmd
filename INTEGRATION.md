...
from [`wasmvm`](https://github.com/PikeEcosystem/wasmvm). There are open issues
for adding [ARM support](https://github.com/PikeEcosystem/wasmvm/issues/53), and
adding [Windows support](https://github.com/PikeEcosystem/wasmvm/issues/28).
...
you may consider simply forking `wasmd`. _I highly advise against this_.
