...
import (
	...
	"github.com/PikeEcosystem/cosmos-sdk/simapp/helpers"
	"github.com/PikeEcosystem/cosmos-sdk/snapshots"
	sdk "github.com/PikeEcosystem/cosmos-sdk/types"
	"github.com/PikeEcosystem/cosmos-sdk/types/errors"
	...
	tmtypes "github.com/PikeEcosystem/tendermint/types"
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, opts []wasm.Option, balances ...banktypes.Balance) *WasmApp {
	...
	app.Commit()
	app.BeginBlock(tmabci.RequestBeginBlock{Header: tmproto.Header{
...
func SignCheckDeliver(
	...
	app.BeginBlock(tmabci.RequestBeginBlock{Header: header})
