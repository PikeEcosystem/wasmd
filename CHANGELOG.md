...
This patch release includes only the wasmvm upgrade to [v1.2.4](https://github.com/PikeEcosystem/wasmvm/releases/tag/v1.2.4).
It solves some incompatibility problems by improving cache invalidation. See [\#426](https://github.com/PikeEcosystem/wasmvm/issues/426)
...
- Upgrade wasmvm to v1.2.3 [\#1355](https://github.com/CosmWasm/wasmd/pull/1355), see [wasmvm v1.2.3](https://github.com/PikeEcosystem/wasmvm/releases/tag/v1.2.3)
...
- Upgrade wasmvm to v1.2.1 [\#1245](https://github.com/CosmWasm/wasmd/pull/1245), see [wasmvm v1.2.1](https://github.com/PikeEcosystem/wasmvm/releases/tag/v1.2.1)
...
- Disallow storing new codes with ACCESS_TYPE_ONLY_ADDRESS [\#1144](https://github.com/CosmWasm/wasmd/issues/1144)
...
- Upgrade wasmvm to v1.1.1 [\#1012](https://github.com/CosmWasm/wasmd/pull/1012), see [wasmvm v1.1.1](https://github.com/PikeEcosystem/wasmvm/releases/tag/v1.1.1)
...
- Fix chain id setup in contrib/local/setup_wasmd.sh [\#318](https://github.com/CosmWasm/wasmd/pull/318) ([orkunkl](https://github.com/orkunkl))
